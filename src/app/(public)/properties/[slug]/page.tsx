...
export async function generateMetadata({
  ...
  if (!property) return { title: "Không tìm thấy tin | Thanh Hóa Land" };
...
export default async function PropertyDetailPage({
  ...
  const mapEmbedUrl = getGoogleMapsEmbedUrl(mapCoordsQuery, undefined, {
    width: 900,
    height: 420,
    zoom: 14,
  });
      ...
      <PublicShell settings={settings}>
            ...
            <article className="detailContent">
              <div className="detailStats">
                <div>
                  ...
                  {pricePerSquareMeter && <small>{pricePerSquareMeter}</small>}
                </div>
                <div>
        ...
        {relatedProperties.length > 0 && (
          <section className="section container relatedSection">
            ...
            <div className="grid relatedGrid">
